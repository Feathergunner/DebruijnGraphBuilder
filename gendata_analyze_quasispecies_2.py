...
k_relative_settings = [0.4, 0.5, 0.6, 0.7]
readlength_settings = [50, 100, 250]
error_percentage = 0

num_reads_settings = [[50000,50000,10000,5000], [50000,25000,10000,1000], [50000]*10+[5000]*5+[1000]*5]
...
for num_reads in num_reads_settings:
	for readlength in readlength_settings:
